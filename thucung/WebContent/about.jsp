...
<meta name="keywords"
	content="Travel Agency Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, 
		...
		<div class="container">
			...
			<div class="col-md-6 top-left">
				<ul>
					...
					<li><i class="fa fa-map-marker" aria-hidden="true"></i> số 13,
						tổ 4, Bắc Từ Liêm, Hà Nội</li>
				</ul>
			</div>
			...
			<div class="header">
				<nav class="navbar navbar-default">
					<div class="navbar-header navbar-left">
						...
						<h1>
							<a class="navbar-brand" href="index.jsp">Vòng Quanh Đất Nước</span></a>
						</h1>
					</div>
					...
					<div class="collapse navbar-collapse navbar-right"
						...
						<nav class="cl-effect-15" id="cl-effect-15">
							<ul class="nav navbar-nav">
								...
								<li class="active"><a href="about.jsp">Xem Thêm Tour</a></li>
								<li><a href="booking.jsp">Đăng Ký Tour</a></li>
								<!---- <li><a href="gallery.jsp">Gallsery</a></li> ---->
<!-- 								<li class="dropdown"><a href="#" class="dropdown-toggle" -->
<!-- 									data-hover="Miền" data-toggle="dropdown" role="button" -->
<!-- 									aria-haspopup="true" aria-expanded="false">Miền <span -->
<!-- 										class="caret"></span></a> -->
<!-- 									<ul class="dropdown-menu"> -->
<!-- 										<li><a href="typography.html">Du Lịch Miền Bắc</a></li> -->
...
<!-- 											</br> -->
<%--                                             <h6><%=t.getTour_customer_notes() %></h6> --%>
<!-- 										</ul> -->
<%-- 										<h4><%=t.getTour_price() %><span class="sup">VND</span> </h4> --%>
<!-- 										<div class="more"> -->
<!-- 											<a href="booking.jsp">Chọn Tour</a>				 -->
<!-- 										</div> -->
<!-- 									</div> -->
<!-- 								</div> -->
<%-- 				<%} %>				 --%>
...
<!-- 				End-slider-script -->
			...
			<div class="container2">
						...
						<div class="col-md-4 agile_footer_grid">
							...
							<ul class="w3_address">
								<li><i class="glyphicon glyphicon-map-marker"
									aria-hidden="true"></i>Số 13, Tổ 4, Bắc Từ Liêm, Hà Nội.</span></li>
								<li><i class="glyphicon glyphicon-envelope"
									aria-hidden="true"></i><a href="mailto:info@example.com">info@example.com</a></li>
								<li><i class="glyphicon glyphicon-earphone"
									aria-hidden="true"></i>+03931117</li>
							</ul>
						</div>
						<div class="col-md-4 agile_footer_grid">
							<h3>Thông Tin</h3>
							<p>Đội ngũ phát triển mong quý khách hàng có được dịch vụ tốt
								nhất, nhanh nhất và tiện lợi nhất.</p>
							...
							<ul class="agileits_w3layouts_footer_grid_list">
								<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>
									<a href="#" data-toggle="modal" data-target="#myModal"><a
										href="http://http://dulich.pystravel.vn/"> Du Lịch Miền
											Bắc</a></li>
								<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>
									<a href="#" data-toggle="modal" data-target="#myModal"><a
										href="http://http://dulich.pystravel.vn/">Du Lịch Miền
											Trung</a></li>
								<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>
									<a href="http://http://dulich.pystravel.vn/"> Du Lịch Miền
										Nam</a></li>
								<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i>
				...
				<div class="agileinfo_copyright">
					<p>
						Nhóm 21-Phát Triển Phần Mềm Hướng Dịch Vụ <a
							href="http://HAUI.edu.vn/">DHCNHN</a>
					</p>
				</div>
			</div>
					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<p>
								...
								qui dolorem eum fugiat quo voluptas nulla pariatur. <i>"
